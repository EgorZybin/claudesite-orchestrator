...
<!--
Vendored from https://github.com/ilyautov/humanizer-ru (MIT license).
Original file: skills/humanizer-ru/SKILL.md
Used as a prompt template for HumanizerRuAdapter — the LLM rewrites prose
following these instructions. YAML frontmatter from upstream is stripped
(it was Claude-plugin discovery metadata, not part of the instructions).
-->
